...
export default function CastYourVote({ onCastVote }: CastYourVoteProps) {
    return (
            ...
            <div className="mx-auto max-w-[900px] text-center">
                ...
                <Reveal delay={0.3} variants={fadeIn}>
                    <div className="flex flex-col items-center gap-5">
                        <button
                            onClick={onCastVote}
                            className="group inline-flex items-center justify-center gap-2.5 rounded-full bg-gradient-to-r from-accent to-accent-warm px-10 py-4 text-base font-semibold text-white transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-accent/20"
                        >
                            Cast Your Vote
                            <svg
                                width="18"
