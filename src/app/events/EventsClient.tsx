...
const fallbackMeta: EventsSectionContent = {
  ...
  description:
    "From family fun days to youth-led podcast sessions, our events bring people together to connect, heal, and celebrate. Here's what we've been up to.",
};

export default function EventsClient(props: { events: EventData[]; meta: EventsSectionContent | null }) {
  const { events, meta } = props;
    ...
    <div className="min-h-screen">
      ...
      <section className="px-5 pb-16 sm:px-6 md:pb-24">
        <div className="mx-auto max-w-[1200px]">
          <motion.div className="grid gap-6 sm:gap-8" initial="hidden" animate="visible" variants={staggerContainer}>
            {events.map((event, i) => (
                ...
                >
                  <div className="grid md:grid-cols-2">
                    ...
                    <div className="p-6 sm:p-8 md:p-10">
                      ...
                      <p className="mb-5 leading-relaxed text-text-secondary">{event.description}</p>

                      {/* Highlights */}
                      <div className="mb-5">
                        <p className="mb-2 text-sm font-semibold text-text-primary">Highlights</p>
                      ...
                      {event.impact.length > 0 && (
                        <div className="mb-5">
                          <p className="mb-2 text-sm font-semibold text-text-primary">Impact</p>
      ...
      <section className="border-t border-border px-5 py-12 text-center sm:px-6">
        <p className="mb-4 text-text-secondary">Want to get involved in our next event?</p>
        <Link
          href="/contact"
