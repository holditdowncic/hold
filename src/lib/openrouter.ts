...
function systemPrompt(): string {
  return [
    ...
    "Do not include HTML tags in string values. Use plain text only.",
    ...
    "Contact fields live in section `contact`: section_label, heading, description, items[]. Contact info displayed site-wide is driven by contact.items[]. To change Email/Instagram/Location/Phone, update the corresponding item by label (\"Email\", \"Instagram\", \"Location\", \"Phone\"). For Email, keep href as mailto:...; for Phone, keep href as tel:...; for Instagram, keep href as https://www.instagram.com/<handle>.",
