...
export const events: EventData[] = [
  {
    ...
    gallery: [
      ...
      { src: "/media/roots/roots-11.jpeg", alt: "Families enjoying the fun day activities" },
      { src: "/media/roots/roots-3.jpeg", alt: "Young person with medal" },
      { src: "/media/roots/roots-13.jpeg", alt: "Fathers at outdoor discussion" },
      { src: "/media/roots/roots-7.jpeg", alt: "Face painting at the event" },
      { src: "/media/roots/roots-17.jpeg", alt: "Dancing and performing" },
